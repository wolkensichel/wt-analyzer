...
for i in range(end_year-start_year):
    ...
    user_lists_files.append('data/BL1/season/data_season_BL1_s' + str(year_var1) + '-' + str(year_var2) + '.pickle')
    user_lists_files.append('data/BL2/season/data_season_BL2_s' + str(year_var1) + '-' + str(year_var2) + '.pickle')
...
for i in range(end_year-start_year):
    year_var1 = str(start_year+i) if len(str(start_year+i)) == 2 else '0' + str(start_year+i)
    year_var2 = str(start_year+1+i) if len(str(start_year+1+i)) == 2 else '0' + str(start_year+1+i)
    user_votes_files.append('data/BL1/votes/votes_BL1_s' + str(year_var1) + '-' + str(year_var2) + '.pickle')
    user_votes_files.append('data/BL2/votes/votes_BL2_s' + str(year_var1) + '-' + str(year_var2) + '.pickle')    
